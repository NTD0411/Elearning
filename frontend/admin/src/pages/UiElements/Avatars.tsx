...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Elearning - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Elearning - React.js Tailwind CSS Admin Dashboard Template"
      />
