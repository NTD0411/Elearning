...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Elearning - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Elearning - React.js Tailwind CSS Admin Dashboard Template"
      />
