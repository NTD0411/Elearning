...
export default function FeedbackView({ submissionId, onClose }: FeedbackViewProps) {
          ...
          <div className="mt-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-medium text-blue-800">Mentor Feedback</h4>
                <div className="text-sm text-blue-600">
                  {feedback.mentorName && `By ${feedback.mentorName}`}
            ...
            <div className="mb-6">
              <h4 className="font-medium text-gray-900 mb-3">
                Discussion ({feedback.replies.length} {feedback.replies.length === 1 ? 'reply' : 'replies'})
              </h4>
              
              {feedback.replies.length > 0 ? (
                <div className="space-y-3">
                  {feedback.replies.map((reply) => (
                    <div key={reply.replyId} className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-medium text-gray-800">{reply.userName || 'Student'}</span>
                ...
                <div className="text-center py-4 text-gray-500">
                  No replies yet. Be the first to start a discussion!
                </div>
              )}
            </div>
